...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4 = new HotDrinks(50, 4, "Hot Water", 1, 80);
        Product item5 = new HotDrinks(150, 5, "Coffee", 2, 50);
        Product item6 = new HotDrinks(100, 6, "Black Tea", 3, 50);
        assort.add(item1);
        assort.add(item2);
        assort.add(item3);
        assort.add(item4);
